...
class TGN(torch.nn.Module):
    def __init__(self,
        ...
        self.predict_next_dest_layer = torch.nn.Linear(2 * self.n_node_features, self.n_node_features)
    ...
    """
        ...
        score = self.predict_next_dest_layer(
            torch.cat([source_node_embedding, destination_node_embedding], dim=1))

        return score, self.memory.get_memory(next_destination_nodes)
